...
swiper2.on('slideChange', function () {
  ...
  const titleContainer2 = document.getElementById('swiper-title2');
  if (textElement2 != undefined) textElement2.remove();
  textElement2 = document.createTextNode(
    'スライド' + (swiper2.realIndex + 1) + 'を表示しています',
  );
  titleContainer2.appendChild(textElement2);
});
